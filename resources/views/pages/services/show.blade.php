...
@section('content')
    ...
    <section>
        <div class="container">
            ...
            <ol class="steps">
                @foreach ($service['steps'] ?? ['تواصل معنا عبر الواتساب أو الاتصال وأرسل صور ' . ($service['name'] ?? 'الأثاث') . ' + موقعك في ' . ($business['city'] ?? 'جدة') . '.', 'سنقوم بتقييم مبدئي للسعر وتحديد موعد للمعاينة إذا لزم الأمر.', 'الاتفاق على السعر النهائي وموعد النقل المناسب لك.', 'فريقنا سيقوم بالفك والنقل والدفع الفوري قبل المغادرة.'] as $step)
                    <li>{{ $step }}</li>
                @endforeach
            </ol>
        </div>
