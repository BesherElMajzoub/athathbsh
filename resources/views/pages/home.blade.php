...
@section('content')
    ...
    <section class="alt">
        <div class="container">
            <h2>كيف نقوم ب شراء اثاث مستعمل في جدة ؟
            </h2>
            <ol class="steps">
                <li>تواصل اتصال/واتساب وأرسل صور الأغراض والاثاث المستعمل + الحي داخل {{ $business['city'] }}.</li>
    ...
    <section>
        <div class="container">
            <h2>مناطق خدمة شراء اثاث مستعمل جدة
            </h2>
            <p class="section-lead">
                نغطي شراء الاثاث المستعمل بجدة بجميع الاماكن (شمال/جنوب/شرق/غرب) ونصل لموقعك للمعاينة والشراء. حيث نقوم
                بخدمة شراء الاثاث المستعمل بجدة بكافة مناطقها
                شمال جدة جنوب جدة شرق جدة غرب جدة </p>
            <div class="chips">
